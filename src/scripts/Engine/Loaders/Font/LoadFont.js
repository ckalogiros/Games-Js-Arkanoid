...
export function FontCreateUvMap(){
	...
	for (let i = 0; i < s_fontTextures.length; i++) {
		...
		for (let j = 0; j < fontTex.size; j++)
		{
			...
			// and store them to the uvmap
            // fontsUvMap[j][i] = [0.0, 0.0, 0.0, 0.0];
            // fontsUvMap[j][i][U1] = 0.22;
			// fontsUvMap[j][i][U2] = 0.325;
            ...
            // uvmap[i].u1 = transormedU * uv.left;
			// uvmap[i].u2 = transormedU * uv.right;

			// let scalex = (fontTex.advancex - uv.width) / 2;
			// uvmap[i].u1 -= transormedU * scalex;
			// uvmap[i].u2 += transormedU * scalex;

			// uvmap[i].v1 = 0;
			// uvmap[i].v2 = 1;

			// if (fontTex.texHeight % 2)
			// 	uvmap[i].v1 += transormedV;
			
			
			// console.log(fontsUvMap[j][i])
		}
	}
}
...
// export function TextCreateUvCoords(character) {
...
// 			uvs[0] = (1 / 2048) * charStart[i] * 1;
// 			if (i <= 54)
// 				if (i <= 28)
// 					uvs[1] = 0.0;
// 				else
// 					uvs[1] = (1 / 2048) * CHAR_HEIGHT;
// 			else
// 				if (i <= 79)
// 					uvs[1] = (1 / 2048) * CHAR_HEIGHT * 2;
// 				else
// 					uvs[1] = (1 / 2048) * CHAR_HEIGHT * 3;

// 			uvs[2] = (1 / 2048) * charStart[i] * 1;
// 			if (i <= 54)
// 				if (i <= 28)
// 					uvs[3] = (1 / 2048) * CHAR_HEIGHT;
// 				else
// 					uvs[3] = (1 / 2048) * CHAR_HEIGHT * 2;
// 			else
// 				if (i <= 79)
// 					uvs[3] = (1 / 2048) * CHAR_HEIGHT * 3;
// 				else
// 					uvs[3] = (1 / 2048) * CHAR_HEIGHT * 4;

// 			uvs[4] = (1 / 2048) * charEnd[i] * 1;
// 			if (i <= 54)
// 				if (i <= 28)
// 					uvs[5] = (1 / 2048) * CHAR_HEIGHT;
// 				else
// 					uvs[5] = (1 / 2048) * CHAR_HEIGHT * 2;
// 			else
// 				if (i <= 79)
// 					uvs[5] = (1 / 2048) * CHAR_HEIGHT * 3;
// 				else
// 					uvs[5] = (1 / 2048) * CHAR_HEIGHT * 4;
// 			uvs[6] = (1 / 2048) * charEnd[i] * 1;

// 			if (i <= 54)
// 				if (i <= 28)
// 					uvs[7] = 0.0;
// 				else
// 					uvs[7] = (1 / 2048) * CHAR_HEIGHT;
// 			else
// 				if (i <= 79)
// 					uvs[7] = (1 / 2048) * CHAR_HEIGHT * 2;
// 				else
// 					uvs[7] = (1 / 2048) * CHAR_HEIGHT * 3;
